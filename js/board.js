	...
	if(race=='w'){
			...
			black.forEach(function(ele){
				if(ele.type[1]=="p"){
					...
					if(isValidLoc(ele.pos-9)&&getBlockInfo(ele.pos-9)=="none"||getBlockInfo(ele.pos-9).type=="wk"){

						a.push(ele.pos-9)
					}
					if(isValidLoc(ele.pos-11)&&getBlockInfo(ele.pos-11)=="none"||getBlockInfo(ele.pos-11).type=="wk")
						a.push(ele.pos-11)
				}
		...
		let a=[]
			...
			white.forEach(function(ele){
				if(ele.type[1]=="p"){
					...
					if(isValidLoc(ele.pos+9)&&getBlockInfo(ele.pos+9)=="none"||getBlockInfo(ele.pos+9).type=="bk"){

						a.push(ele.pos+9)
					}
					if(isValidLoc(ele.pos+11)&&getBlockInfo(ele.pos+11)=="none"||getBlockInfo(ele.pos+11).type=="bk")
						a.push(ele.pos+11)
				}
				else if(ele.type[1]=="k"){
					a=a.concat(ele.moves)
...
function bpress(blockid){
	...
	if(select.id==-1&&chance=="white"){
		...
		else if(white[selectedblock.sno].getMoves().find((ele)=>ele==blockid)){
		...
		else if(black[selectedblock.sno].getMoves().find((ele)=>ele==blockid)){
			move(select.id,blockid)
